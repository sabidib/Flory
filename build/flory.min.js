...
Flory.RandomGen.prototype.genrand_res53=function(){var a=this.genrand_int32()>>>5,b=this.genrand_int32()>>>6;return 1.1102230246251565E-16*(67108864*a+b)};Flory.Newtonian=function(){Flory.Environment.call(this)};Flory.Newtonian.prototype=Object.create(Flory.Environment.prototype);
...
Flory.timestep)));return this};Flory.ContinuousField=function(a){Flory.Field.call(this,[]);this.scaler=1;this.field_function=void 0!=a?a:function(){}};Flory.ContinuousField.prototype=Object.create(Flory.Field.prototype);Flory.ContinuousField.prototype.constructor=Flory.ContinuousField;Flory.ContinuousField.prototype.getForce=function(a){return this.field_function(a).mult(this.scaler)};Flory.ContinuousField.prototype.scale=function(a){"number"===typeof a&&(this.scaler=a);return this};
Flory.ContinuousField.prototype.clone=function(){return new Flory.ContinuousField(this.field_function)};
