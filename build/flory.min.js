var Flory={VERSION:"0.01",timestep:.01,Vector3:function(a,b,c){this.x=void 0===a?0:a;this.y=void 0===b?0:b;this.z=void 0===c?0:c}};
...
Flory.RandomGen.prototype.init_by_array=function(a,b){var c,f,d;this.init_genrand(19650218);c=1;f=0;for(d=this.N>b?this.N:b;d;d--){var e=this.mt[c-1]^this.mt[c-1]>>>30;this.mt[c]=(this.mt[c]^(1664525*((e&4294901760)>>>16)<<16)+1664525*(e&65535))+a[f]+f;this.mt[c]>>>=0;c++;f++;c>=this.N&&(this.mt[0]=this.mt[this.N-1],c=1);f>=b&&(f=0)}for(d=this.N-1;d;d--)e=this.mt[c-1]^this.mt[c-1]>>>30,this.mt[c]=(this.mt[c]^(1566083941*((e&4294901760)>>>16)<<16)+1566083941*(e&65535))-c,this.mt[c]>>>=0,c++,c>=this.N&&
...
(this.data[b].vector=a[b].vector.clone())};Flory.Field.prototype=Object.create(Flory.Entity.prototype);Flory.Field.prototype.constructor=Flory.Field;Flory.Field.prototype.getForce=function(a,b){for(var c=Infinity,f=0,d=0,e=this.data.length;d<e;d++){var g=this.data[d].position.distanceToSq(a);g<=c&&(f=d,c=g)}return this.data[f].vector};Flory.Field.prototype.combine=function(a){};Flory.Field.prototype.scale=function(a){for(var b=0,c=this.data.length;b<c;b++)this.data[b].vector.scale(a)};
...
this.data[b].vector=new Flory.Vector2(a[b].vector[0],a[b].vector[1]):void 0!=a[b].vector.x&&void 0!=a[b].vector.y&&(this.data[b].vector=a[b].vector.clone())};Flory.Field2D.prototype=Object.create(Flory.Entity.prototype);Flory.Field2D.prototype.constructor=Flory.Field2D;Flory.Field2D.prototype.getForce=function(a,b){for(var c=0,f=0,d=0,e=this.data.length;d<e;d++){var g=this.data[d].position.distanceToSq(a);g<=c&&(f=d,c=g)}return this.data[f].vector};Flory.Field2D.prototype.combine=function(a){};
...
Flory.Field3D.prototype.getForce=function(a,b){for(var c=0,f=0,d=0,e=this.data.length;d<e;d++){var g=this.data[d].position.distanceToSq(a);g<=c&&(f=d,c=g)}return this.data[f].vector};Flory.Field3D.prototype.combine=function(a){};Flory.Field3D.prototype.scale=function(a){for(var b=0,c=this.data.length;b<c;b++)this.data[b].vector.scale(a)};Flory.Field3D.prototype.clone=function(){return new Flory.Field3D(this.data)};
Flory.Monomer2D=function(a,b,c,f){Flory.Entity.call(this);var d=void 0,e=void 0,g=void 0,h=void 0;void 0!=f&&(d=f.position,e=f.velocity,g=f.acceleration,h=f.force);this.radius=void 0!=a?a:Flory.Monomer2D.defaultRadius;this.charge=void 0!=b?b:0;this.mass=void 0!=c?c:0;void 0==d?this.position=new Flory.Vector2(0,0):d instanceof Array?this.position=new Flory.Vector2(d[0],d[1]):void 0!=d.x&&void 0!=d.y&&(this.position=new Flory.Vector2(d.x,d.y));void 0==e?this.velocity=new Flory.Vector2(0,0):e instanceof
Array?this.velocity=new Flory.Vector2(e[0],e[1]):void 0!=e.x&&void 0!=e.y&&(this.velocity=new Flory.Vector2(e.x,e.y));void 0==g?this.acceleration=new Flory.Vector2(0,0):g instanceof Array?this.acceleration=new Flory.Vector2(g[0],g[1]):void 0!=g.x&&void 0!=g.y&&(this.acceleration=new Flory.Vector2(g.x,g.y));void 0==h?this.force=new Flory.Vector2(0,0):h instanceof Array?this.force=new Flory.Vector2(h[0],h[1]):void 0!=h.x&&void 0!=h.y&&(this.force=new Flory.Vector2(h.x,h.y))};
...
Flory.Monomer3D=function(a,b,c,f){Flory.Entity.call(this);var d=void 0,e=void 0,g=void 0,h=void 0;void 0!=f&&(d=f.position,e=f.velocity,g=f.acceleration,h=f.force);this.radius=void 0!==a?a:Flory.Monomer3D.defaultRadius;this.charge=void 0!==b?b:0;this.mass=void 0!=c?c:0;void 0==d?this.position=new Flory.Vector3(0,0):d instanceof Array?this.position=new Flory.Vector3(d[0],d[1]):void 0!=d.x&&void 0!=d.y&&void 0!=d.z&&(this.position=new Flory.Vector3(d.x,d.y));void 0==e?this.velocity=new Flory.Vector3(0,
0):e instanceof Array?this.velocity=new Flory.Vector3(e[0],e[1]):void 0!=e.x&&void 0!=e.y&&void 0!=e.z&&(this.velocity=new Flory.Vector3(e.x,e.y));void 0==g?this.acceleration=new Flory.Vector3(0,0):g instanceof Array?this.acceleration=new Flory.Vector3(g[0],g[1]):void 0!=g.x&&void 0!=g.y&&void 0!=g.z&&(this.acceleration=new Flory.Vector3(g.x,g.y));void 0==h?this.force=new Flory.Vector3(0,0):h instanceof Array?this.force=new Flory.Vector3(h[0],h[1]):void 0!=h.x&&void 0!=h.y&&void 0!=h.z&&(this.force=
...
Flory.Monomer=function(a,b,c,f){if(void 0==f)console.log("Flory: Flory.Monomer needs at least the kinematics.position to know what the dimension of the monomer is.");else if(void 0==f.position)console.log("Flory: Flory.Monomer needs at least the kinematics.position to know what the dimension of the monomer is.");else{Flory.Entity.call(this);var d=void 0,e=void 0,g=void 0,h=void 0;void 0!=f&&(d=f.position,e=f.velocity,g=f.acceleration,h=f.force);this.radius=void 0!=a?a:Flory.Monomer.defaultRadius;
this.charge=void 0!=b?b:0;this.mass=void 0!=c?c:0;this.position=void 0==d.components&&d instanceof Array?new Flory.Vector(d):d.clone();this.velocity=void 0==e?new Flory.Vector([].slice.apply(new Uint8Array(this.position.dimension()))):void 0==e.components&&e instanceof Array?new Flory.Vector(e):e.clone();this.acceleration=void 0==g?new Flory.Vector([].slice.apply(new Uint8Array(this.position.dimension()))):void 0==g.components&&g instanceof Array?new Flory.Vector(g):g.clone();this.force=void 0==h?
...
Flory.Monomer.prototype.clone=function(){return new Flory.Monomer3D(this.radius,this.position)};Flory.Monomer.defaultRadius=1;Flory.Newtonian=function(){Flory.Environment.call(this)};Flory.Newtonian.prototype=Object.create(Flory.Environment.prototype);Flory.Newtonian.constructor=Flory.Newtonian;
Flory.Newtonian.prototype.update=function(a){a=0;for(var b=this.entities.length;a<b;a++){var c=this.entities[a],f=new Flory.Vector;if(c instanceof Flory.Monomer){for(var d=0,b=this.entities.length;d<b;d++){var e=this.entities[d];e instanceof Flory.Field&&f.add(e.getForce(c.position))}c.force=f.clone()}}a=0;for(b=this.entities.length;a<b;a++)c=this.entities[a],c instanceof Flory.Monomer&&(c.acceleration=c.force.mult(1/c.mass),c.velocity.add(c.acceleration.mult(Flory.timestep)),c.position.add(c.velocity.mult(.5*
...
Flory.RandomWalk.prototype.update=function(a){a=0;for(var b=this.entities.length;a<b;a++){var c=this.entities[a];if(c instanceof Flory.Monomer){for(var f=1/c.position.dimension(),d=0,e=this.randomGen.random(),e=e-f;0<e;)e-=f,d++;e=this.randomGen.random();.5>e?c.position.components[d]++:c.position.components[d]--}}return this};Flory.LennardJones=function(a,b){Flory.Environment.call(this);this.epsilon=void 0!=a?a:Flory.LennardJones.default_epsilon;this.sigma=void 0!=b?b:Flory.LennardJones.default_sigma};
...
Flory.LennardJones.prototype.update=function(a){a=0;for(var b=this.entities.length;a<b;a++){var c=this.entities[a],f=new Flory.Vector(this.entities[a].position.dimension());if(c instanceof Flory.Monomer){for(var d=0,b=this.entities.length;d<b;d++){var e=this.entities[d];if(e instanceof Flory.Monomer&&e.id!=c.id){var e=e.position.clone().sub(c.position),g=e.length();if(!(g>Flory.LennardJones.far_cutoff_distance)){var h=this.sigma/g,e=e.scale(24*this.epsilon/(g*g)*(2*Math.pow(h,12)-Math.pow(h,6)));
f.add(e)}}}c.force=f.clone()}}a=0;for(b=this.entities.length;a<b;a++)c=this.entities[a],c instanceof Flory.Monomer&&(c.acceleration=c.force.mult(1/c.mass),c.velocity.add(c.acceleration.mult(Flory.timestep)),c.position.add(c.velocity.mult(.5*Flory.timestep)));return this};Flory.LennardJones.far_cutoff_distance=100;Flory.LennardJones.default_sigma=1;Flory.LennardJones.default_epsilon=1;
