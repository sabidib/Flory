...
Flory.Environment.prototype={constuctor:Flory.Environment,add:function(a){if(this.id==a.id)console.log("Flory: Can't add an entity to itself.");else{for(var c=0,d=this.entities.length;c<d;c++)if(this.entities[c].id===a.id){console.log("Flory : Can't add an entity twice to the same enviroment.");return}this.entities.push(a)}}};
Flory.Field=function(a){Flory.Entity.call(this);this.data=[];for(var c=0,d=a.length;c<d;c++)this.data[c]={},void 0==a[c].position?this.data[c].position=new Flory.Vector(a[c][0]):a[c].position instanceof Array?this.data[c].position=new Flory.Vector(a[c].position):void 0!=a[c].position.components&&(this.data[c].position=a[c].position.clone()),void 0==a[c].vector?this.data[c].vector=new Flory.Vector(a[c][1]):a[c].vector instanceof Array?this.data[c].vector=new Flory.Vector(a[c].vector):void 0!=a[c].vector.components&&
(this.data[c].vector=a[c].vector.clone())};Flory.Field.prototype=Object.create(Flory.Entity.prototype);Flory.Field.prototype.constructor=Flory.Field;Flory.Field.prototype.getForce=function(a,c){for(var d=0,e=0,f=0,g=this.data.length;f<g;f++){var h=this.data[f].position.distanceToSq(a);h<d&&(e=f,d=h)}return this.data[e].vector};Flory.Field.prototype.scale=function(a){for(var c=0,d=this.data.length;c<d;c++)this.data[c].vector.scale(a)};Flory.Field.prototype.clone=function(){return new Flory.Field(this.data)};
Flory.Field2D=function(a){Flory.Entity.call(this);this.data=[];for(var c=0,d=a.length;c<d;c++)this.data[c]={},void 0==a[c].position?this.data[c].position=new Flory.Vector2(a[c][0][0],a[c][0][1]):a[c].position instanceof Array?this.data[c].position=new Flory.Vector2(a[c].position[0],a[c].position[1]):void 0!=a[c].position.x&&void 0!=a[c].position.y&&(this.data[c].position=a[c].position.clone()),void 0==a[c].vector?this.data[c].vector=new Flory.Vector2(a[c][1][0],a[c][1][1]):a[c].vector instanceof Array?
this.data[c].vector=new Flory.Vector2(a[c].vector[0],a[c].vector[1]):void 0!=a[c].vector.x&&void 0!=a[c].vector.y&&(this.data[c].vector=a[c].vector.clone())};Flory.Field2D.prototype=Object.create(Flory.Entity.prototype);Flory.Field2D.prototype.constructor=Flory.Field2D;Flory.Field2D.prototype.getForce=function(a,c){for(var d=0,e=0,f=0,g=this.data.length;f<g;f++){var h=this.data[f].position.distanceToSq(a);h<d&&(e=f,d=h)}return this.data[e].vector};
Flory.Field2D.prototype.scale=function(a){for(var c=0,d=this.data.length;c<d;c++)this.data[c].vector.scale(a)};Flory.Field2D.prototype.clone=function(){return new Flory.Field2D(this.data)};
Flory.Field3D=function(a){Flory.Entity.call(this);this.data=[];for(var c=0,d=a.length;c<d;c++)this.data[c]={},void 0==a[c].position?this.data[c].position=new Flory.Vector3(a[c][0][0],a[c][0][1],a[c][0][2]):a[c].position instanceof Array?this.data[c].position=new Flory.Vector3(a[c].position[0],a[c].position[1],a[c].position[2]):void 0!=a[c].position.x&&void 0!=a[c].position.y&&void 0!=a[c].position.z&&(this.data[c].position=a[c].position.clone()),void 0==a[c].vector?this.data[c].vector=new Flory.Vector3(a[c][1][0],
a[c][1][1],a[c][1][2]):a[c].vector instanceof Array?this.data[c].vector=new Flory.Vector3(a[c].vector[0],a[c].vector[1],a[c].vector[2]):void 0!=a[c].vector.x&&void 0!=a[c].vector.y&&void 0!=a[c].postiion.z&&(this.data[c].vector=a[c].vector.clone())};Flory.Field3D.prototype=Object.create(Flory.Entity.prototype);Flory.Field3D.prototype.constructor=Flory.Field3D;
Flory.Field3D.prototype.getForce=function(a,c){for(var d=0,e=0,f=0,g=this.data.length;f<g;f++){var h=this.data[f].position.distanceToSq(a);h<d&&(e=f,d=h)}return this.data[e].vector};Flory.Field3D.prototype.scale=function(a){for(var c=0,d=this.data.length;c<d;c++)this.data[c].vector.scale(a)};Flory.Field3D.prototype.clone=function(){return new Flory.Field3D(this.data)};Flory.Vector3=function(a,c,d){this.x=void 0===a?0:a;this.y=void 0===c?0:c;this.z=void 0===d?0:d};
...
Flory.Monomer=function(a,c,d,e,f){Flory.Entity.call(this);this.radius=void 0!=a?a:Flory.Monomer.defaultRadius;this.charge=void 0!=c?c:0;this.position=void 0==d.components&&d instanceof Array?new Flory.Vector(d):d.clone();this.velocity=void 0==e.components&&e instanceof Array?new Flory.Vector(e):e.clone();this.acceleration=void 0==f.components&&f instanceof Array?new Flory.Vector(f):f.clone()};Flory.Monomer.prototype=Object.create(Flory.Entity.prototype);
